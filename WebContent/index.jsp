...
<body id="page-top" class="index">
	...
	<div class="container">
		...
		<div class="navbar-header page-scroll">
			...
			<a class="navbar-brand" href="#page-top">Compatibility Testing
				Platform</a>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="intro-text">
					...
					<hr class="star-light">
					<span class="skills">Android devices & wearable
						compatibility</span>
				</div>
				<Form Method="GET" Action="device" Enctype="Multipart/Form-Data">
					<div
						class="col-lg-4 col-lg-offset-4 text-center">
						<Input Type="Submit" class="btn btn-lg btn-outline" Name="start" value="Start Now¡÷">
					</div>
				</Form>
			</div>
		</div>
